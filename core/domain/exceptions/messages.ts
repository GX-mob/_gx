export enum DomainExceptionsMessages {
  ...
  InvalidFederalID = "invalid-federal-id",
  ContactRemovalNotAllowed = "remove-contact-not-allowed",
  PasswordRequired = "password-required",
  ContactAlreadyRegistred = "contact-already-registred",
  NotOwnContact = "not-own-contact",
