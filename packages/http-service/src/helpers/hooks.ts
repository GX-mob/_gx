...
/**
 * Protects requests
 * @param {SessionService} service Session service
 * @param {FastifyRequest} request The request to analize
 * @param {number[]} alloweds Allowed access groups
 */
...
/**
 * Used to avoid exposing internal errors
 * @param {Error} error
 * @param {FastifyReply} reply The request to analize
 */
